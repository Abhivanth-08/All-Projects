    ...
    try:
        ...
        for i, item in enumerate(text_data):
            ...
            try:
                ...
                original_fitz_rect = fitz.Rect(fitz_x0, fitz_y0, fitz_x1, fitz_y1)
                page.draw_rect(original_fitz_rect, color=(0, 0.7, 0.7), width=0.5)  # Cyan outline
                print(f"  Drew original bbox outline {original_fitz_rect}.")
