    ...
    if document.texts:
        for text_item in document.texts:
            if text_item.prov:
                ...
                text = text_item.text
                bbox = prov.bbox
                li2.append({"page_no": prov.page_no-1, "bbox": {"l": bbox.l, "t": bbox.t, "r": bbox.r, "b": bbox.b},"text":text_item.text})
    ...
    if document.pictures:
        for pic_item in document.pictures:
            if pic_item.prov:
                ...
                bbox = prov.bbox
                li.append({"page_no":prov.page_no-1,"bbox":{"l":bbox.l,"t":bbox.t,"r":bbox.r,"b":bbox.b}})
                ...
                if pic_item.children:
                    ...
                    for child_ref in pic_item.children:
                        ...
                        if found_text and found_text.prov:
                            ...
                            li2.append({"page_no": child_prov.page_no - 1,"bbox": {"l": child_prov.bbox.l, "t": child_prov.bbox.t, "r": child_prov.bbox.r, "b": child_prov.bbox.b},"text": found_text.text})
